...
-- Awesome
  ...
  awful.key({ mod, "Shift" }, 't', function() awful.util.spawn("telegram-desktop") end),
  awful.key({ mod, "Shift" }, 'd', function() awful.util.spawn("discord") end),
  awful.key({ mod, "Shift" }, 'w', function() awful.util.spawn("whatsapp-nativefier") end), 
  awful.key({ mod, "Shift" }, 'v', function() awful.util.spawn("tradingview") end),
  awful.key({ mod, "Shift" }, 'm', function() awful.util.spawn("microsoft-edge-dev") end),
  awful.key({ mod, "Shift" }, 'c', function() awful.util.spawn("scrcpy") end),
  awful.key({ mod, "Shift" }, 'p', function() awful.util.spawn("wps") end),
  awful.key({ mod, "Shift" }, 'o', function() awful.util.spawn("koodo-reader") end),
  awful.key({ mod }, 'e', function() awful.util.spawn("nautilus") end),
  awful.key({ mod }, 'space', function() awful.util.spawn('rofi -show drun -show-icons -theme apps') end),
...
keys.clientkeys = gears.table.join(
    awful.key({ mod, "Shift" }, "n", function () 
      awful.util.spawn("setxkbmap -layout latam")
  end),
